...
class CGPTFC_HTML_Template_Uploader {
    ...
    /**
     * Append HTML template to prompt with size optimization
    ...
    public function append_html_template_to_prompt($user_prompt, $prompt_id, $form_data) {
        ...
        // OPTIMIZATION: Reduce template size by removing comments and excessive whitespace
        $html_template = $this->optimize_html_template($html_template);
     ...
     * @return string The optimized HTML template
     */
    private function optimize_html_template($html) {
        ...
        // Remove unnecessary whitespace at the start of lines
        $html = preg_replace('/^\s+/m', '', $html);
