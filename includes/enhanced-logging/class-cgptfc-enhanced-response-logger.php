<?php
/**
 * Enhanced ChatGPT Response Logger Class
 * 
 * Handles detailed logging and retrieval of AI responses including both success and failure cases
 */
...
class CGPTFC_Enhanced_Response_Logger {
    ...
    public function check_table_version() {
        $table_version = get_option('cgptfc_logs_table_version', '1.0');
        
        // If the table version is less than 1.1, we need to update it
        if (version_compare($table_version, '1.1', '<')) {
            $this->update_table_to_v1_1();
            update_option('cgptfc_logs_table_version', '1.1');
        }
    }
    
    /**
     * Update table structure to v1.1 (adding status field, provider, error_message)
     */
    public function update_table_to_v1_1() {
        global $wpdb;
    ...
    /**
     * Render enhanced logs page with filters and detailed views
     */
    public function render_logs_page() {
        ...
        <div class="wrap">
            ...
            <style>
                ...
                /* Existing API provider badges from admin-styles.css */
                .cgptfc-api-badge {
                    display: inline-block;
                    padding: 3px 8px;
                    border-radius: 10px;
    ...
    /**
     * Render detailed view of a specific log entry
     * 
     * @param int $log_id The log ID to view
     */
