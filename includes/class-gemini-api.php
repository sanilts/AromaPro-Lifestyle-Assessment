...
protected function get_model_chunk_sizes($model) {
    $chunk_sizes = array(
        'gemini-1.5-pro-latest' => array('default' => 7500, 'max' => 8192),
        'gemini-1.5-flash-latest' => array('default' => 7500, 'max' => 8192),
        'gemini-2.0-flash-exp' => array('default' => 7500, 'max' => 8192),
        'gemini-2.5-flash' => array('default' => 7800, 'max' => 8192),
        'gemini-2.5-pro' => array('default' => 7800, 'max' => 8192),
        'gemini-exp-1219' => array('default' => 7500, 'max' => 8192),
    );
    
    return isset($chunk_sizes[$model]) ? $chunk_sizes[$model] : array('default' => 7000, 'max' => 8192);
}
